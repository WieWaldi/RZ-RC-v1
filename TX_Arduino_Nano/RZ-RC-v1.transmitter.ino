...
#define DELAY_TIME 5000                                                         // Delay time between measurements
#define UpdateScreenInterval 500                                                // Update screen interval in milliseconds
...
void loop() {
  ...
  if (rotaryCLKstate != rotaryPrevCLKstate && rotaryCLKstate == HIGH) {
...
rotaryButtonState = digitalRead(SW_PIN);
  ...
  if (rotaryButtonState != rotaryPrevButtonState) {
